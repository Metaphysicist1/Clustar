...
for period in range(0, 4):
    ...
    start_date = f"2025-04-{7*period+1:02d}"
    end_date = f"2025-04-{7*period+8:02d}"
...
dataframe.to_csv('nasa_neo_browse_datasetx.csv', index=False, encoding='utf-8')
print(f"\nDataset saved to nasa_neo_browse_dataset.csv")